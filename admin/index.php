                                            ...
                                            <div class="card-body pt-2 pb-2">
                                                <div class="d-md-flex align-items-center browser-stats">
                                                    <div class="d-flex me-1">
                                                        <i class="fa fa-chrome bg-secondary-gradient text-white me-2 logo-icon"></i>
                                                        <p class="fs-16 my-auto mb-0">Chrome</p>
                                                    </div>
                                                    <div class="ms-auto my-auto">
                                                        <div class="d-flex">
                                                            <span class="my-auto fs-16">35,502</span>
                                                            <span class="text-success fs-15 ms-3"><i class="fe fe-arrow-up"></i>12.75%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-md-flex align-items-center browser-stats">
                                                    <div class="d-flex me-1">
                                                        <i class="fa fa-opera text-white bg-danger-gradient me-2 logo-icon"></i>
                                                        <p class="fs-16 my-auto mb-0">Opera</p>
                                                    </div>
                                                    <div class="ms-auto my-auto">
                                                        <div class="d-flex">
                                                            <span class="my-auto fs-16">12,563</span>
                                                            <span class="text-danger fs-15 ms-3"><i class="fe fe-arrow-down"></i>15.12%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-md-flex align-items-center browser-stats">
                                                    <div class="d-flex me-1">
                                                        <i class="fa fa-firefox text-white bg-purple-gradient me-2 logo-icon"></i>
                                                        <p class="fs-16 my-auto mb-0">IE</p>
                                                    </div>
                                                    <div class="ms-auto my-auto">
                                                        <div class="d-flex">
                                                            <span class="my-auto fs-16">25,364</span>
                                                            <span class="text-success fs-15 ms-3"><i class="fe fe-arrow-up"></i>24.37%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-md-flex align-items-center browser-stats">
                                                    <div class="d-flex me-1">
                                                        <i class="fa fa-edge text-white bg-info-gradient me-2 logo-icon"></i>
                                                        <p class="fs-16 my-auto mb-0">Firefox</p>
                                                    </div>
                                                    <div class="ms-auto my-auto">
                                                        <div class="d-flex">
                                                            <span class="my-auto fs-16">14,635</span>
                                                            <span class="text-success fs-15 ms-3"><i class="fe fe-arrow-up"></i>15,63%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-md-flex align-items-center browser-stats">
                                                    <div class="d-flex me-1">
                                                        <i class="fa fa-android text-white bg-success-gradient me-2 logo-icon"></i>
                                                        <p class="fs-16 my-auto mb-0">Android</p>
                                                    </div>
                                                    <div class="ms-auto my-auto">
                                                        <div class="d-flex">
                                                            <span class="my-auto fs-16">15,453</span>
                                                            <span class="text-danger fs-15 ms-3"><i class="fe fe-arrow-down"></i>23.70%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
