...
$record = mysqli_query($conn, "SELECT * FROM banner WHERE id='1'");
...
<body class="app sidebar-mini ltr light-mode">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql =  "UPDATE banner SET title='$title',des='$des' WHERE id='1'";
        // echo $sql;
        // die;

        $data = mysqli_query($conn, $sql);
        if ($data) {
            echo "<script>alert('Data Updated Into Database'); window.location.href='home_banner.php';</script>";
        } else {
